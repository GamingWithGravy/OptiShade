...
//go:embed neural-download.ps1 recovery.ps1 FusionCinema/* Help/*.txt updates.ps1 update-worker.ps1 update-install.ps1 compatibility.ps1 manager.ps1 library.ps1 ownership.ps1 effects.ps1 consent.ps1 EffectPackages.ini all:PayloadFusion FusionSetup.exe manager.xaml OptiShade.ico OptiShade-app.ico OptiShade-icon.png nvidia.ps1 nvidia-files.json streamline-files.json
var bundle embed.FS
