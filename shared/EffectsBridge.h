...
namespace osfx {
constexpr uint32_t Version=6, MaxTechniques=4096, MaxUniforms=512;
enum Kind:uint32_t { Effects=1, Reload, Preset, Technique, Uniform, Save, Load, Inspect, SaveAs, Discard, PerformanceMode };
