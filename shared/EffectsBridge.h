...
namespace osfx {
constexpr uint32_t Version=5, MaxTechniques=4096, MaxUniforms=512;
enum Kind:uint32_t { Effects=1, Reload, Preset, Technique, Uniform, Save, Load, Inspect, SaveAs, Discard };
...
struct Snapshot {uint32_t version,connected,loading,compileOK,enabled,techniques,uniforms,truncated;uint64_t generation,frames,effectFrames,applied,rejected,saveSerial;uint32_t saveOK,dirty;char savePath[1024];char preset[1024];TechniqueInfo technique[MaxTechniques];UniformInfo uniform[MaxUniforms];};
