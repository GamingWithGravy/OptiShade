# OptiShade licence map

This repository contains separately licensed components. This map does not
replace their licences or change previously granted rights.

| Component | Applicable licence |
| --- | --- |
...
preserved for existing references and tooling; this map does not turn the runtime
into proprietary software. See [LICENSING.md](LICENSING.md) and [NOTICE.md](NOTICE.md).
