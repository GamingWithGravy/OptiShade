...
static void TryHotSwap(){
 ...
 if(Send(c)){swapNextAllowed=GetTickCount64()+1000;LOG_INFO("OptiShade preset hotswap requested: {}",next.filename().string());}
}
...
static void DrawHotSwap(){
 ...
 DrawHotSwapKeybind();
 ImGui::TextUnformatted("Hotswap Preset");ImGui::SameLine();ImGui::SetNextItemWidth(300);
